...
class MakePDF():
    ...
    def __init__(self, fatores, liquidez, matriz_correl,
        ...
        shutil.move(f'./{self.nome_arquivo}', f'./dados/pdfs_backtest/premios_de_risco/{self.nome_arquivo}')

    def primeira_pagina(self):

        self.pdf.image(os.path.join(".", "dados", "pdfs_backtest", "imagens", "comparando_1Q.png"), w = 180, h = 90, x = 13, y = 60)
        self.pdf.image(os.path.join(".", "dados", "pdfs_backtest", "imagens", "comparando_premios.png"), w = 180, h = 90, x = 13, y = 160)
    ...
    def pagina_fator(self, nome_fator, liquidez):
        ...
        self.pdf.add_page()
        self.pdf.image(os.path.join(".", "dados", "pdfs_backtest", "imagens", f"barras_quartis_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 10, y = 60)
        self.pdf.image(os.path.join(".", "dados", "pdfs_backtest", "imagens", f"linha_quartis_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 110, y = 60)
        self.pdf.image(os.path.join(".", "dados", "pdfs_backtest", "imagens", f"movel_12m_premio_de_risco_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 10, y = 160)
        self.pdf.image(os.path.join(".", "dados", "pdfs_backtest", "imagens", f"premio_de_risco_{nome_fator}_{liquidez}.png"), w = 95, h = 80, x = 110, y = 160)