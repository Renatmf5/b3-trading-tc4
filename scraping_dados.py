...
if __name__ == "__main__":
    #df = pd.read_parquet(os.path.join("dados", "balancos", "balancos_consolidados.parquet"))
    #df
    #pd.Series(df['descricao'].unique()).to_csv('contas_cvm.csv', index=False)
    ...
    try:
        ...
        scraping.process_table_in_batches(batch_size=2)
