...
class MakeResultsPremium:
    ...
    def retorno_quartis(self):
        ...
        for i, nome_premio in enumerate(self.lista_nome_fatores):
            ...
            plt.savefig(os.path.join(".", "dados", "pdfs_backtest", "imagens", f'barras_quartis_{nome_premio}_{self.liquidez[i]}'))
            ...
            plt.savefig(os.path.join(".", "dados", "pdfs_backtest", "imagens", f'linha_quartis_{nome_premio}_{self.liquidez[i]}'))
            ...
            plt.savefig(os.path.join(".", "dados", "pdfs_backtest", "imagens", f'premio_de_risco_{nome_premio}_{self.liquidez[i]}'))
            ...
            plt.savefig(os.path.join(".", "dados", "pdfs_backtest", "imagens", f'movel_12m_premio_de_risco_{nome_premio}_{self.liquidez[i]}'))
        ...
        plt.savefig(os.path.join(".", "dados", "pdfs_backtest", "imagens", f'comparando_1Q'))
        ...
        plt.savefig(os.path.join(".", "dados", "pdfs_backtest", "imagens", f'comparando_premios'))
