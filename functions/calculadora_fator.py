...
from reports import MakeReportResult
import os
...
class backtest_indicators():
    ...
    def pegando_dados(self):
        ...
        volume_mediano = pd.read_parquet(os.path.join('.', 'dados', 'indicadores', 'volume_mediano.parquet'))
        ...
        volume_mediano.columns = ['data', 'ticker', 'volume_mediano']
    ...
    def criando_carteiras(self):
        ...
        df_dados = self.df_dados
        df_dados = df_dados[df_dados['volume_mediano'] > self.liquidez]
...
if __name__ == "__main__":
    ...
    backtest = backtest_indicators(data_final="2024-12-31", data_inicial= '2011-01-01', filtro_liquidez=(filtro_liquidez * 1000000), balanceamento=balanceamento, 
