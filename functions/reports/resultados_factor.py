...
class MakeReportResult():
    ...
    def grafico_retorno_acum(self):
        ...
        plt.savefig(os.path.join('.', 'dados', 'pdfs_backtest', 'imagens', 'rent_acum.png'), dpi = 300)
    ...
    def grafico_retorno_mes_a_mes(self):
        ...
        plt.savefig(os.path.join('.', 'dados', 'pdfs_backtest', 'imagens', 'grafico_mes.png'), dpi = 300)
    ...
    def underwater(self):
        ...
        plt.savefig(os.path.join('.', 'dados', 'pdfs_backtest', 'imagens', 'grafico_underwater.png'), dpi = 300)
    ...
    def grafico_retorno_ano_a_ano(self):
        ...
        plt.savefig(os.path.join('.', 'dados', 'pdfs_backtest', 'imagens', 'grafico_ano.png'), dpi = 300)
    ...
    def grafico_retorno_movel(self, df, periodo, coluna):
        ...
        plt.savefig(os.path.join('.', 'dados', 'pdfs_backtest', 'imagens', f'janela_movel_{periodo}_{coluna}.png'), dpi = 300)
